...
HealthyThoughtType.create(name: "Use the 'Some' Shaker", explanation: "Allowing space for some of this and some of that", example: "I am getting some things wrong and I am getting some things right.")
